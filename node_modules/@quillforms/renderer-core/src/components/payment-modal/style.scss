.renderer-core-payment-modal {
	...
	.renderer-core-payment-modal__content {
		max-width: 800px;
		margin: auto;
		padding: 20px;
	}
	.renderer-components-radio-control__options-group {
		display: flex;
	...
	.renderer-core-payment-modal-methods {
		text-align: center;
		margin: auto;
		max-width: 540px;
	...
	.renderer-core-payment-modal-info {
...
.renderer-core-payment-coupon {
	padding: 15px;
	margin-bottom: 20px;
	.renderer-core-payment-coupon__label {
		margin-right: 15px;
		cursor: pointer;
		text-decoration: underline;
	}
	.render-core-payment-coupon-form {
		display: flex;
		align-items: center;
		margin-top: 20px;
		.renderer-core-payment-coupon__apply {
			margin-left: 15px;
		}
	}
}
