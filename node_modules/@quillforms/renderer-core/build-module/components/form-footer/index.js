...
const FormFooter = memo(() => {
  ...
  return createElement("div", {
  ...
  }, createElement(SaveBtn, null), !formObj?.settings?.disableProgressBar && createElement(ProgressBar, null), !formObj?.settings?.disableNavigationArrows && createElement(FieldNavigation, {
    shouldFooterBeDisplayed: shouldFooterBeDisplayed
  }), formObj?.settings?.displayBranding && createElement("div", {
    className: classnames(`renderer-core-powered-by-branding-${random(100)}`, css`
    ...
    target: "_blank"
  }, "Powered By Quill Forms")), createElement("div", {
    className: classnames(`renderer-core-correct-incorrect-result`, {
