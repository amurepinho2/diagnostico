...
const FieldDisplayWrapper = ({
  ...
  const props = {
    ...
    setIsAnswerCorrect: val => setIsFieldAnswerCorrect(id, val),
  ...
  }, blockType?.display && createElement("div", {
    className: css`
  ...
  createElement(blockType.display, {
    ...props
  }), createElement(Fragment, null, isAnswerLocked && correctIncorrectQuiz?.enabled && correctIncorrectQuiz?.questions?.[id]?.explanation?.trim() && createElement("div", {
    className: classnames("renderer-core-field-display-wrapper__explanation", css`
    ...
    className: classnames("renderer-core-field-display-wrapper__explanation__heading", css`
									margin-bottom: 15px;
								`)
  }, createElement("strong", null, messages['label.answersExplanation'])), correctIncorrectQuiz?.questions[id].explanation))), createElement(BlockFooter, {
