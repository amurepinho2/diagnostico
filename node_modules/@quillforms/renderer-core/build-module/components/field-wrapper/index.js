...
const FieldWrapper = () => {
  ...
  function getFocusables(el) {
    return filter(Array.prototype.slice.call(document.querySelector(el).querySelectorAll(focusableElementsString)), item => {
  ...
  function processTab(isShiftPressed) {
    ...
    const activeElementIndex = findIndex(focusableElements, el => el === activeElement);
  ...
  return createElement("div", {
    className: classnames('renderer-components-field-wrapper', {
      active: isActive,
      'is-animating': isAnimating,
      'is-horizontal-animation': settings?.animationDirection === 'horizontal'
    }, `${(_attributes$classname = attributes?.classnames) !== null && _attributes$classname !== void 0 ? _attributes$classname : ''}`, `${theme.typographyPreset}-typography-preset`, position ? position : '', css`
    ...
    className: css`
					...
					height: 100%;
				`
  }, shouldBeRendered && createElement(Fragment, null, createElement("section", {
    id: 'block-' + id,
  ...
  }, createElement(FieldContent, null))), (layout !== 'stack' && deviceWidth !== 'mobile' || deviceWidth === 'mobile' && (layout === 'split-left' || layout === 'split-right')) && blockType?.supports?.attachment && createElement("div", {
    ...
    attributes?.attachmentFocalPoint?.y * 100}%;
										...
										`)
  }, createElement(BlockAttachment, null))))));
};
