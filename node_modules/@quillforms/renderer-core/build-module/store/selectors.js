 ...
 */
export function getCorrectIncorrectDisplay(state) {
 ...
 */
export function isCurrentBlockSafeToSwipe(state) {
 ...
 */
export function getBlockCounterValue(state, id) {
 ...
 */
export const getEditableFieldsInCurrentPath = state => {
  return state.swiper.walkPath.filter(block => {
    return select('quillForms/blocks').hasBlockSupport(block.name, 'editable');
  });
};
 ...
 */
export const getFieldsBySupportCriteria = (state, supportCriteria) => {
...
export function getAnsweredFieldsLength(state) {
  const answeredFields = pickBy(state.answers, value => value?.isAnswered === true);
 ...
 */
export function getInvalidAnswers(state) {
 ...
 */
export const getFirstInvalidFieldId = state => {
  ...
  if (size(invalidFields) > 0) {
    ...
    const firstField = find(walkPath, o => invalidFieldsIds.includes(o.id));
 ...
 */
export function isAnsweredField(state, id) {
 ...
 * @return {boolean} showErr flag
 */
export function hasValidFields(state, id) {
 ...
 * @param id 
 */
export function isFieldAnswerCorrect(state, id) {
 ...
 * @param id
 */
export function isFieldAnswerLocked(state, id) {
 ...
 * @param id
 */
export function isFieldCorrectIncorrectScreenDisplayed(state, id) {
 ...
 */
export function isFieldPending(state, id) {
 ...
 */
export function getPendingMsg(state) {
 ...
 */
export function isFocused(state) {
 ...
 * @return {boolean} isFocused flag
 */
export function shouldFooterBeDisplayed(state) {
 ...
 */
export function getSubmissionErr(state) {
 ...
 */
export function getCorrectAnswersCount(state) {
 ...
 */
export function getIncorrectAnswersCount(state) {
