...
const shortTextControl = ({
  ...
  })), minCharacters !== false && (0, _react.createElement)(_adminComponents.TextControl, {
    type: "number",
    value: minCharacters,
    onChange: val => {
      setAttributes({
  ...
  })), setMaxCharacters && (0, _react.createElement)(_adminComponents.TextControl, {
    type: "number",
    value: maxCharacters,
...
var _default = exports.default = shortTextControl;
