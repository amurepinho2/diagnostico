...
const DropdownDisplay = props => {
  ...
  const $choices = useMemo(() => {
    return cloneDeep(choices).map((choice, index) => {
  ...
  return createElement("div", {
    ...
    autoComplete: "off"
  }), val && val.length > 0 || showCloseIcon && (!isTouchScreen || isIframed) ? createElement(CloseIcon, {
    onClick: () => {
      clearTimeout(timer);
      timer2 && clearTimeout(timer2);
      setSearchKeyword('');
    ...
    return createElement(ChoiceItem, {
      blockId: id,
      choiceIndex: index,
    ...
    className: cx(css`
								...
								border-radius: 5px;
							`)
  }, messages['block.dropdown.noSuggestions'])), showFixedDropdownInDom && createElement(Fragment, null, createPortal(createElement("div", {
