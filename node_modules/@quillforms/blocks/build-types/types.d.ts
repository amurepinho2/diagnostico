...
import { SET_BLOCK_ADMIN_SETTINGS, SET_BLOCK_RENDERER_SETTINGS, ADD_BLOCK_TYPES } from './store/constants';
...
export interface BlockRendererSettings {
    ...
    isConditionFulfilled?(conditionOperator: string, conditionVal: unknown, fieldValue: unknown): boolean;
}
export declare type BlockSupportedFeatures = {
    innerBlocks?: boolean;
    controls?: boolean;
    attachment?: boolean;
    description?: boolean;
...
declare type logicalOperator = 'is' | 'is_not' | 'starts_with' | 'greater_than' | 'lower_than' | 'ends_with' | 'contains' | 'not_contains';
...
export declare type BlockActionTypes = setBlockRendererSettingsAction | setBlockAdminSettingsAction | addBlockTypesAction | ReturnType<() => {
    type: 'NOOP';
}>;
export {};
