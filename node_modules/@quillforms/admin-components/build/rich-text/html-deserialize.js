...
const deserializeHTML = htmlString => {
  return normalize(deserialize(new DOMParser().parseFromString(formatBeforeDeserializing((0, _autop.autop)(htmlString)), 'text/html').body));
};
...
const normalize = val => {
  ...
  const editor = (0, _createEditor.default)();
  editor.children = val;
...
const deserialize = el => {
  ...
  if (el.nodeName === 'BODY') {
    return (0, _slateHyperscript.jsx)('fragment', descendants);
  }
...
var _default = exports.default = deserializeHTML;
