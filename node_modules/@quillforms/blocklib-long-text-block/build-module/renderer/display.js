 ...
 */
import { useMessages, HTMLParser, useBlockTheme } from '@quillforms/renderer-core';
...
const LongTextOutput = props => {
  ...
  return createElement(Fragment, null, createElement(TextareaAutosize, {
    ref: inputRef,
    ...
    className: classnames(css`
						& {
							...
							padding-bottom: 8px;
							background: ${tinyColor(answersColor).setAlpha(0.1).toString()} !important;
