 ...
 */
import { __experimentalUseFieldRenderContext, Button, useBlockTheme } from '@quillforms/renderer-core';
import { isRTL } from '@wordpress/i18n';
const NextBtnComponent = ({
  onClick
}) => {
  const {
    attributes
...
const CounterIconComponent = () => {
  ...
  return createElement(Fragment, null, quotationMarks && createElement("div", {
